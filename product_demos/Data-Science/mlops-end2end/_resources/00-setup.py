...
dbutils.widgets.text("schema","retail_mlops", "Schema to use")


# COMMAND ----------

# MAGIC %run ../../../../_resources/00-global-setup $reset_all_data=$reset_all_data $dbName=schema $min_dbr_version=13.3 $catalog=$catalog
